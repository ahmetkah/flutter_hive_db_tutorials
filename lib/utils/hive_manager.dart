...
class HiveManager {
  HiveManager() {
    ...
    debugPrint('HiveManager [constructor] çalıştı');
  }
  ...
  static Future init() async {
    ...
    debugPrint('HiveManager [init] çalıştı');
  }
  ...
  void incrementCounter() {
    ...
    debugPrint('incrementCounter çalıştı');
  }
  ...
  void resetCounter() {
    ...
    debugPrint('resetCounter çalıştı');
  }
  ...
  void decrementCounter() {
    ...
    _boxCounter.put(BoxManager.instance.keyNameCounter, (_counter--) - 1);
    debugPrint('decrementCounter çalıştı');
  }
  ...
  void close() {
    ...
    /// Hive.close();
    debugPrint('HiveManager [close] çalıştı');
  }
}
